...
import com.example.mplab06.Modals.WeatherRVModal;
import com.example.mplab06.databinding.FragmentFirstBinding;
...
//        cloudiness_val = view.findViewById(R.id.cloudiness_val);
//        pressure_val = view.findViewById(R.id.pressure_val);
    ...
    public void getWeatherInfo(){
        ...
        String url = "http://api.weatherapi.com/v1/forecast.json?key=7a1a63388d7c489486850959222603&q=" + city_name + "&days=1&aqi=no&alerts=no";
